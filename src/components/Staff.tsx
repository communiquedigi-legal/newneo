...
export default function Staff() {
  ...
  const handleAddStaff = async () => {
    ...
    const staffToAdd = {
      ...
      specialty: newStaff.specialty || 'General',
      degree: newStaff.degree || '',
      qualification: newStaff.degree || '',
      ...
      consultation_fee: isDoctorOrSurgeon(newStaff.role) && newStaff.consultationFee ? Number(newStaff.consultationFee) : 0,
  ...
  const handleUpdateStaff = async () => {
    ...
    const updates = {
      ...
      specialization: editingStaff.specialty || editingStaff.specialization || 'General',
      specialty: editingStaff.specialty || editingStaff.specialization || 'General',
      degree: editingStaff.degree || editingStaff.qualification || '',
      qualification: editingStaff.qualification || editingStaff.degree || '',
      ...
      consultation_fee: isDoctorOrSurgeon(editingStaff.role) && editingStaff.consultationFee ? Number(editingStaff.consultationFee) : 0,
      registrationNo: editingStaff.registrationNo || editingStaff.regNo || '',
      regNo: editingStaff.registrationNo || editingStaff.regNo || '',
      labLicenseNo: isLabOrPharmacy(editingStaff.role) ? (editingStaff.labLicenseNo || editingStaff.licenseNumber || '') : '',
      licenseNumber: isLabOrPharmacy(editingStaff.role) ? (editingStaff.labLicenseNo || editingStaff.licenseNumber || '') : '',
      avatar: finalAvatar,
